...
public class AndroidGraphics implements Graphics {
    ...
    @Override
    public void drawMirror(Image Image, int x, int y) {
        Matrix matrix = new Matrix();
        matrix.preScale(-1.0f, 1.0f);
        Bitmap src = ((AndroidImage) Image).bitmap;
        Bitmap dst = Bitmap.createBitmap(src, 0, 0, Image.getWidth(), Image.getHeight(), matrix, false);
        canvas.drawBitmap(dst, x, y, null);
    }
    @Override
    public void drawUpDown(Image Image, int x, int y) {
        Matrix matrix = new Matrix();
        matrix.preScale(-1.0f, -1.0f);
        Bitmap src = ((AndroidImage) Image).bitmap;
        Bitmap dst = Bitmap.createBitmap(src, 0, 0, Image.getWidth(), Image.getHeight(), matrix, false);
